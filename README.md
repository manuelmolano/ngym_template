...
NeuroGym Template is a curated collection of neuroscience tasks with a common interface.
...
NeuroGym Template inherits from the machine learning toolkit [Gym](https://github.com/openai/gym) by OpenAI, 
...
NeuroGym Template also incorporates several properties and functions (e.g. continuous-time and trial-based tasks) that are important for neuroscience applications.
...
NeuroGym Template is compatible with most packages that use OpenAI gym. 
